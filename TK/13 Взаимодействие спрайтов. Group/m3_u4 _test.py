...
car2 = Game_sprite(randint(100,300),
                   '../14 Взаимодействие спрайтов. Продолжение. Создание зависимых элементов игры/Car2.png', cars)
gr_left = Game_sprite(33, '../14 Взаимодействие спрайтов. Продолжение. Создание зависимых элементов игры/gr.png', green_left)
gr_right=Game_sprite(367, '../14 Взаимодействие спрайтов. Продолжение. Создание зависимых элементов игры/gr.png', green_right)
road=Game_sprite(200, '../14 Взаимодействие спрайтов. Продолжение. Создание зависимых элементов игры/road.png', road_group)
line_1 = Game_sprite(200, '../14 Взаимодействие спрайтов. Продолжение. Создание зависимых элементов игры/line.png', road_group)
line_2 = Game_sprite(200, '../14 Взаимодействие спрайтов. Продолжение. Создание зависимых элементов игры/line.png', road_group)
    ...
    if game_over==1:
        ...
        if line_1.rect.y < H:
            ...
            line_1 = Game_sprite(200,
                                 '../14 Взаимодействие спрайтов. Продолжение. Создание зависимых элементов игры/line.png', road_group)
            line_1.rect.y = -400
