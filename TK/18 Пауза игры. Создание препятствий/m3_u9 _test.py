...
def menu_def():
    ...
    if pause==0:
        ...
        global go
        go = sc.blit(btn_cont.image,btn_cont.rect)
...
cont_group=pygame.sprite.Group()
...
btn_cont=Game_sprite(200,'cont.png',cont_group)
...
btn_pause=Game_sprite(365, 'pause.png', pause_group)
...
while game:
    ...
    if game_over==1:
        if pause==0:
            ...
            cont=sc.blit(btn_pause.image,btn_pause.rect)
            ...
            if s>=10 and s<20:
                ...
                sc.blit(text_per,(347,30))
                sc.blit(text_level,(5,370))
                sc.blit(btn_pause.image,btn_pause.rect)
            ...
            if pygame.sprite.spritecollideany(car1,water_group):
                car1.rect.x = randint(100,300)
                car1.rect.y=randint(50,100)
