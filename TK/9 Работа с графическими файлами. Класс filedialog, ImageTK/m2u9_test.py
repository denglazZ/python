...
canvas_brush=Canvas(root,width=62,height=62)
canvas_brush.pack()
canvas_brush.place(x=375,y=85)
...
var_scale=IntVar()
scale = Scale(root,from_=3, to=200, length=150, orient=HORIZONTAL, resolution=5, variable=var_scale, command=brush_size)
scale.pack()
